/* Dev fixture: Adsterra social bar (desktop). Self-anchors to the viewport bottom. */
(function () {
  var bar = document.createElement('div');
  bar.setAttribute('data-fake-ad', 'socialbar-desktop');
  bar.textContent = 'SOCIAL BAR desktop';
